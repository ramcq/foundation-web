...
YEAR = 2020
CANDIDATES_OPENED_DATE    = (YEAR, 5, 18)
CANDIDATES_CLOSED_DATE    = (YEAR, 5, 29)
CANDIDATES_ANNOUNCED_DATE = (YEAR, 5, 30)
VOTING_OPENED_DATE        = (YEAR, 6, 1)
VOTING_CLOSED_DATE        = (YEAR, 6, 14)
PRELIMINARY_RESULTS_DATE  = (YEAR, 6, 15)
CHALLENGE_CLOSED_DATE     = (YEAR, 6, 22)
