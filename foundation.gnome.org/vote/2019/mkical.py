...
CANDIDATES_CLOSED_DATE    = (YEAR, 6, 02)
CANDIDATES_ANNOUNCED_DATE = (YEAR, 6, 03)
VOTING_OPENED_DATE        = (YEAR, 6, 04)
VOTING_CLOSED_DATE        = (YEAR, 6, 18)
PRELIMINARY_RESULTS_DATE  = (YEAR, 6, 19)
CHALLENGE_CLOSED_DATE     = (YEAR, 6, 26)
